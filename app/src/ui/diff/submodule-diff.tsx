...
export class SubmoduleDiff extends React.Component<ISubmoduleDiffProps> {
  ...
  private renderOpenSubmoduleAction() {
    ...
    return (
      <span>
        <SuggestedAction
          title="Open this submodule on Blackfin"
          description="You can open this submodule on Blackfin as a normal repository to manage and commit any changes in it."
